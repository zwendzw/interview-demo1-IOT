...
// 接收來自 SOCKET SERVER 的資料
static void do_read(int epollfd, int eventfd);
// 傳送資料至 SOCKET SERVER
void *send_data(const char * data);
// 連線至本地端的 SOCKET SERVER
void *connect_socket();
// 判斷訊息的 client
int detect_socket_stat();
// 建立回傳給 AWS IOT 的 REPORT 資料
...
// 控制 AWS IOT REPORT 與 DELTA
void *aws_iot_register();
// 建立回傳 AWS Iot 的資料 Json 格式
char *create_reported_helper(char **data);
// UPDATE SHADOW 後的狀態回報
